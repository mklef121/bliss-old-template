...
//exit();
    $query = "select workInfo_id, StaffNo  from workinformtion_tb";
     $result = mysqli_query($con,$query);
       $options= '<option value="">All Staff</option>';
        while($row=mysqli_fetch_array($result)){
           // $faculty_id = $row["faculty_id"];
           // $faculty_Name = $row["facuty_Name"];
...
<!--nav-->
 <div class="w3-top">
   <div class="w3-bar w3-black w3-mobile">
     ...
     <div class="w3-container w3-mobile w3-teal w3-center" style="width:100%;margin-top:2px; min-width:500px;">
        <h5 class="w3-teal w3-center w3-margin-top">Memo Handler</h5>
     </div>
 <!--content-->
    ...
    <form class="w3-container" action="javascript:void(0)" method="post">
        ...
        <div class="w3-col m6">
          <div class="w3-section">
                   <select id="levelCC" onchange="courServer()" class="w3-select w3-light-gray w3-border " name="option" >
                      <option value="" disabled selected>Mail Category</option>
      ...
      <div class="w3-container">
         <div class=" w3-container w3-margin-top w3-margin-bottom">
                     ...
                     <button type="submit" class="w3-btn w3-right w3-round w3-blue" onclick="declearWorkLoad()"> <i class="fa fa-mail-forward"></i> Send Mail</button>
         </div>
      </div>
      </fieldset>
    </form>
